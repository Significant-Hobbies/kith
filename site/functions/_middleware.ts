// CF Pages Functions middleware for kith.significanthobbies.com:
...
const SITE_URL = "https://kith.significanthobbies.com";

const OPENAPI_SPEC = {
  openapi: "3.1.0",
  info: {
    title: "Kith public API",
    version: "1.0.0",
    description:
      "Kith is a private iPhone app for the people you want to stay close to. The public web API exposes read-only agent surfaces: the agent catalog, sitemap, llms.txt, and per-page markdown alternates.",
    contact: { name: "Kith", url: SITE_URL },
  },
...
\`${path}\` does not exist on kith.significanthobbies.com.
